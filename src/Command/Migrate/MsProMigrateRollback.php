...
/**
 * Class MsProMigrateRollback
 * @package System\Command\Migrate
 */
#[Command]
class MsProMigrateRollback extends BaseCommand
{
    use ConfirmableTrait;

    protected ?string $name = 'mspro:migrate-rollback';
    ...
    public function __construct(Migrator $migrator)
    {
        ...
        $this->setDescription('The run migrate rollback class of MsProAdmin module');
    }
