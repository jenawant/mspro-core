 ...
 */
#[Command]
class MsProMigrate extends BaseCommand
{
     ...
     *
     * @var MsProMigrationCreator
     */
    protected $creator;

    /**
     * Create a new migration install command instance.
     * @param MsProMigrationCreator $creator
     */
    public function __construct(MsProMigrationCreator $creator)
    {

        parent::__construct('mspro:migrate-gen');
        $this->setDescription('Generate a new MsProAdmin module migration file');
