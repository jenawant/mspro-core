...
/**
 * Class MsProMigrateRun
 * @package System\Command\Migrate
 */
#[Command]
class MsProMigrateRun extends BaseCommand
{
    use ConfirmableTrait;

    protected ?string $name = 'mspro:migrate-run';
    ...
    public function __construct(Migrator $migrator)
    {
        ...
        $this->setDescription('The run migrate class of MsProAdmin module');
    }
