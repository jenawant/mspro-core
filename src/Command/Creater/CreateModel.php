 ...
 */
#[Command]
class CreateModel extends MsProCommand
{
    protected ?string $name = 'mspro:model-gen';

    public function configure()
    {
        parent::configure();
        $this->setHelp('run "php bin/hyperf.php mspro:model-gen <--module | -M <module>> [--table | -T [table]]"');
